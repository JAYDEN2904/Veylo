...
import { EmailVerificationRequiredError } from '../../services/authService';
        ...
        >
          ...
          >
            ...
            <Typography className="text-gray-400 text-center text-base" style={{ maxWidth: 280 }}>
              Join Veylo to start your smart fashion journey
            </Typography>
          </Animated.View>
          ...
          <Animated.View entering={FadeInDown.duration(500).delay(800)}>
            ...
            >
              <Typography className="text-gray-400">Already have an account? </Typography>
